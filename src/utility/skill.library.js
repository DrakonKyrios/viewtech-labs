export const skills = [
  { name: "HTML \\ CSS", isProficient: true, isUsed: true, children: [] },
  {
    ...
    children: [
      ...
      { name: "Typescript", isProficient: true, isUsed: false, children: [] },
  ...
  },
  {
    ...
    children: [
      ...
      { name: "Hibernate", isProficient: false, isUsed: false, children: [] },
  ...
  { name: "TensorFlow", isProficient: false, isUsed: false, children: [] },
  { name: "CI/CD", isProficient: false, isUsed: true, children: [] },
];
